...
def load_model():
    try:
        return pickle.load(open(r'C:\Users\91701\.spyder-py3\streamlit.pkl', 'rb'))
    except FileNotFoundError:
        st.error("Model file not found. Please ensure 'streamlit.pkl' is in the correct directory.")
        return None
